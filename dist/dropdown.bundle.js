...
`];var S=function(e,t,i,s){var r,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let z=class extends x{constructor(){super(...arguments),this.isListVisible=!1,this._inputLabel="",this.items=g,this.multiselect=!1}get clearButtonHtml(){return e.dy`
            <div
                    class="clear-button"
        ...
        `}openList(e){e.stopPropagation(),this.isListVisible=!this.isListVisible}connectedCallback(){super.connectedCallback(),window.addEventListener("click",(()=>{this.isListVisible=!1}))}getInputTemplate(){return e.dy`
            <input
