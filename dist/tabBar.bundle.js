...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./config */ "./src/tab-bar/config.ts");
...
let TabBar = class TabBar extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    ...
    render() {
        return lit__WEBPACK_IMPORTED_MODULE_0__.html `
            <div class="container">
                ${this.items.map(tab => lit__WEBPACK_IMPORTED_MODULE_0__.html `<div class=${(0,lit_directives_class_map_js__WEBPACK_IMPORTED_MODULE_2__.classMap)({
            'tab-item': true,
            active: tab.name === this.selectedTabName,
            disabled: this.disabled
        })} @click=${() => this.selectTab(tab.name)}>${tab.name}</div>`)}
            </div>
        `;
    }
};
...
TabBar = __decorate([
    (0,_utils_other_custom_element_decorator__WEBPACK_IMPORTED_MODULE_3__.customElementRegistry)('tsc-tab-bar')
], TabBar);
...
/******/ })()
;
//# sourceMappingURL=tabBar.bundle.js.map