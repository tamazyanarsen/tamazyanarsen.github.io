...
`,n`
        * {
        ...
        <div class="container border-radius-4">
            ...
            `,k`${function(t,i,s){return t?e:null==s?void 0:s()}(t,0,(()=>""))}`}
        </div>`;var t,e}};ot.styles=[st,n`
    .title {
    ...
    `],rt([tt({state:!0})],ot.prototype,"isOpen",void 0),rt([tt({type:Boolean})],ot.prototype,"disabled",void 0),ot=rt([t=>"function"==typeof t?((t,e)=>(window.customElements.define("tsc-accordion",e),e))(0,t):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(t){window.customElements.define("tsc-accordion",t)}}})(0,t)],ot)})();