...
`;let p=class extends c{render(){return s.dy`
    ...
    `,o=function(e,t,i,s){var r,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n}([(0,r.U)("tsc-divider")],o),i(940);var n=i(9662),a=i(3692),l=i(875);const c=(0,l.XM)(class extends l.Xe{constructor(e){var t;if(super(e),e.type!==l.pX.ATTRIBUTE||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const s=e[i];return null==s?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const s=t[e];null!=s&&(this.ct.add(e),e.includes("-")?i.setProperty(e,s):i[e]=s)}return a.Jb}});var d=i(3279),h=i.n(d);const u=[s.iv`
.border-radius-4 {
...
`,s.iv`
        * {
            box-sizing: border-box;
        }`];var p=i(4357),v=function(e,t,i,s){var r,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let b=class extends s.oi{constructor(){super(...arguments),this.items=[],this.itemHeight="10em",this.maxHeight="calc(var(--base-size) * 91)",this.scrollbarHeight=0}connectedCallback(){super.connectedCallback(),setTimeout((()=>{this.scrollbarHeight=(this.container?.clientHeight||0)/3,this.container?.style.setProperty("--scroll-height",`${this.scrollbarHeight}px`),this.container?.addEventListener("scroll",h()(this.scrollContainer.bind(this),150))}),100)}scrollContainer(){if(this.container){const e=this.container?.scrollTop,t=this.container?.scrollHeight;e+this.scrollbarHeight>=.6*t&&this.dispatchEvent((0,p.y)("scrollPaginate"))}}render(){return s.dy`
        ...
        `],v([(0,n.Cb)({type:Array})],b.prototype,"items",void 0),v([(0,n.Cb)({type:String})],b.prototype,"itemHeight",void 0),v([(0,n.Cb)({type:String})],b.prototype,"maxHeight",void 0),v([(0,n.IO)(".container")],b.prototype,"container",void 0),b=v([(0,r.U)("tsc-scroll")],b);var g=i(8201);const f="selectedValue",y=new Array(200).fill(0).map(((e,t)=>({value:Math.random(),label:(t+1).toString(),subtitle:"some text",inn:1,kpp:12})));var m=function(e,t,i,s){var r,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let $=class extends s.oi{constructor(){super(...arguments),this._items=[],this.multiselect=!1,this.itemLimit=50,this.maxHeight="calc(var(--base-size) * 25)",this.extraLabelKeys=["inn","kpp"],this._visibleItems=[],this.offset=0}set items(e){console.log("get new items",e);const t=(e,t)=>!t||e.some((e=>!t.find((t=>t.value===e.value)))),i=t(e,this.items);console.log("isChanged: ",i),t(e,this.items)&&(this._items=e,this.offset=0,this.visibleItems=[],this.getNextItems())}get items(){return this._items}set visibleItems(e){const t=this.visibleItems.slice();this._visibleItems=e,this.offset+=e.length,this.requestUpdate("visibleItems",t)}get visibleItems(){return this._visibleItems}emitSelectedValue(e){if(!this.multiselect){const t={value:e};this.dispatchEvent((0,p.y)(f,{detail:t}))}}getNextItems(){let e=this.items.slice(this.offset,this.itemLimit+this.offset);0===e.length&&this.paginateFunction&&(e=this.paginateFunction()),this.visibleItems=[...this.visibleItems,...e]}changeSelected(e,t){const i=this.visibleItems.find((t=>t.value===e.value));i&&(i.checked=t);const s={value:this.visibleItems.filter((e=>e.checked))};this.dispatchEvent((0,p.y)(f,{detail:s}))}getListItemText(e){return s.dy`
            <div class="list-item-text">
                ...
                ${(0,g.p)(this.extraLabelKeys.length>0,s.dy`
                            <div class="extra-label">
                                ${this.extraLabelKeys.filter((t=>t in e)).map((t=>s.dy`
                                    <div><span class="subtitle-2 grey-100">${t}</span>:
                                        <span class="subtitle-2 grey-160">${e[t]}</span>
                                    </div>
                                `))}
                            </div>
                        `)}
            </div>
        `}getListItem(e){return this.multiselect?s.dy`
            <tsc-checkbox ?initCheckedState=${e.checked}
                          @change=${t=>this.changeSelected(e,t.detail.checked)}>
                ${this.getListItemText(e)}
            </tsc-checkbox>
        `:this.getListItemText(e)}render(){return s.dy`
            <tsc-scroll .maxHeight=${this.maxHeight} @scrollPaginate=${this.getNextItems}>
                <div class="list">
                    ${this.visibleItems.map((e=>s.dy`
...
`];var A=function(e,t,i,s){var r,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};class S extends s.oi{constructor(){super(...arguments),this.classSettings={M:{placeholder:"subtitle-2",inputText:"body-3",height:"calc(var(--base-size) * 12)"},L:{placeholder:"body-3",inputText:"body-2",height:"calc(var(--base-size) * 14)"},S:{placeholder:"body-3",inputText:"body-2",height:"calc(var(--base-size) * 10)"},XS:{placeholder:"body-3",inputText:"body-2",height:"calc(var(--base-size) * 8)"}},this.outline=!1,this.size=_.M,this.success=!1,this.error=!1,this.placeHolderVisible=!1,this.additionalText="",this.clearButtonVisible=!1,this.name=""}connectedCallback(){super.connectedCallback(),console.log("connectedCallback: ",this.input),setTimeout((()=>{console.log("this.input: ",this.input),this.input}),0)}focusInput(){this.placeHolderVisible=!0,this.clearButtonVisible=!0}blurInput(){this.placeHolderVisible=!!this.input?.value,this.clearButtonVisible=!1}editInput(){const e={value:this.input?.value};this.dispatchEvent((0,p.y)("input-value",{detail:e}))}clearInputValue(){this.input&&(this.input.value=""),this.input?.focus()}changeValue(){const e={value:this.input?.value};this.dispatchEvent((0,p.y)("input-change",{detail:e}))}}S.styles=x,A([(0,n.Cb)({type:Boolean})],S.prototype,"outline",void 0),A([(0,n.Cb)()],S.prototype,"size",void 0),A([(0,n.Cb)({type:Boolean})],S.prototype,"success",void 0),A([(0,n.Cb)({type:Boolean})],S.prototype,"error",void 0),A([(0,n.SB)()],S.prototype,"placeHolderVisible",void 0),A([(0,n.Cb)()],S.prototype,"additionalText",void 0),A([(0,n.IO)("#input")],S.prototype,"input",void 0),A([(0,n.SB)()],S.prototype,"clearButtonVisible",void 0),A([(0,n.Cb)({type:String})],S.prototype,"name",void 0);const z=[u,s.iv`
        .input-wrapper {
            height: calc(var(--base-size) * 12);
            width: 22em;
            position: relative;
...
`];var C=function(e,t,i,s){var r,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let E=class extends S{constructor(){super(...arguments),this.isListVisible=!1,this._inputLabel="",this.items=y,this.multiselect=!1}get clearButtonHtml(){return s.dy`
            <div
                    class="clear-button"
                    style=${c({gridGap:"calc(var(--base-size) * 3)",display:this.clearButtonVisible?"flex":"none"})}
            >
                <svg
        ...
        `}clearInputValue(){this.input&&(this.input.value=""),this._inputLabel=""}set initValue(e){console.log("get init value",e,this.items),this.items&&this.items.length&&(this._inputLabel=this.items.find((t=>t.value===e))?.label||""),console.log("new input label",this._inputLabel)}emitSelectedValue(e){if(console.log("get value:",e.detail.value),Array.isArray(e.detail.value))this._inputLabel=e.detail.value.map((e=>e.label)).join("; ");else if(e.detail.value&&"value"in e.detail.value){const t=e.detail.value;this.isListVisible=!1,this._inputLabel=this.items.find((e=>e.value===t.value))?.label||"",console.log("this._inputLabel: ",this._inputLabel)}}listTemplate(){return s.dy`
        ...
        `}openList(e){e.stopPropagation(),this.isListVisible=!this.isListVisible}connectedCallback(){super.connectedCallback(),window.addEventListener("click",(()=>{this.isListVisible=!1}))}getInputTemplate(){return s.dy`
            <input
                    ...
                    id="input"
                    class=${(0,w.$)({[this.classSettings[this.size].inputText]:!0,outline:this.outline,success:this.success,error:this.error})}
                    .placeholder=${this.placeHolderVisible?"":"Название сделки"}
                    .value=${this._inputLabel}
            />
        `}getIconSVG(){return s.dy`
            <svg
                    width="18"
                    height="10"
                    viewBox="0 0 18 10"
        ...
        `}render(){return s.dy`
            <div class="dropdown" @click=${this.openList}>
                <div
                        class="input-wrapper"
                        style=${c({height:this.classSettings[this.size].height})}
                >
                    ${this.placeHolderVisible?s.dy`
                                <div
                                        class="${(0,w.$)({[this.classSettings[this.size].placeholder]:!0,"input-placeholder":!0})}"
                                >
                                    Название сделки
                                </div>`:""}
                    ${this.getInputTemplate()}
                    <div
                            class=${(0,w.$)({"subtitle-2":!0,"additional-text":!0,success:this.success,error:this.error})}
                    >
                        ${this.additionalText}
                    </div>
                    <div class="input-button">
                        ...
                        <div
                                class=${(0,w.$)({rotate:this.isListVisible,"dropdown-list-icon":!0})}
                        >
                            ${this.getIconSVG()}
                        </div>
                    </div>
